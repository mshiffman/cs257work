...
SELECT county, states, population2021, realGDP2021, realgdp2021/population2021 as GDP_per_Cap FROM counties WHERE realGDP2021 IS NOT NULL AND population2021 IS NOT NULL ORDER BY realgdp2021/population2021 DESC LIMIT 10;
...
SELECT states, AVG(medianAQI) as Average_Median_AQI FROM counties WHERE medianAQI IS NOT NULL GROUP BY states;